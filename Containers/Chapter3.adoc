...
CONTAINER ID  IMAGE                           COMMAND               CREATED        STATUS                         PORTS                 NAMES
e67dea0b9820  localhost/demo-container-image  /usr/sbin/httpd -...  2 minutes ago  Exited (0) About a minute ago  0.0.0.0:8880->80/tcp  demo-container-buildah <4>
----
<1> Looking at images and verifying image exists
<2> Attempting to *prune* images
<3> Image remains after pruning
<4> Image attached to a running or *stopped* container
